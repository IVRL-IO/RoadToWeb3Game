...
<nav class="navbar navbar-expand-lg justify-content-between  flex-column flex-sm-row">
    <!-- Image and text -->
    <nav class="navbar col-1 col-md-1 justify-content-center">
        <a class="navbar-brand text-danger" href="/">
            <img src="GoldPoo.png" style="max-height: 32px" alt="I Stole This and all I got was poo"/>
            I Stole This
        </a>
    </nav>
    <button class="navbar-toggler col-sm-1" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
    </button>
    <span class="nav-item col-md-1 justify-content-left">
        <a class="nav-link" href="#Docs">Documentation</a>
        </span>

    <div class="collapse navbar-collapse justify-content-center col-md-5" id="navbarSupportedContent">

        <ul class="navbar-nav" >
            <li class="nav-item">
                <span class="nav-link text-danger"><b>Connected Users: <span class="text-success">{socket.usersTotal}</span></b> </span>

            </li>
            <li class="nav-item">
                <span class="nav-link text-danger"><b>User in round: <span class="text-success">{socket.users}</span></b></span>

            </li>
            <li class="nav-item">
                <span class="nav-link text-danger"><b>Estimated NFT Value: <span class="text-success">{socket.value}</span></b></span>

            </li>
            <li class="nav-item">
                <span class="nav-link text-danger"><b>Gas Price: <span class="text-success">{wallet.gasPrice}</span></b> </span>
            </li>
        </ul>

    </div>
    <div class="navbar-text offset-md-1 col-md-1 justify-content-end">
        {#if wallet.connected}
